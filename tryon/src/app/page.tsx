    ...
    <body className="flex flex-col justify-between min-h-screen bg-white">
      <div className="flex flex-col items-center w-full justify-center flex-1">
        <div className="flex justify-center mb-6">
          <Image src="../public/login/moss.png" alt="Avatar" width={96} height={96} className="rounded-full object-cover" />
        </div>

        <h1 className="text-2xl font-bold text-center mb-2 text-gray-800">Bem-vindo ao TryOn!</h1>
        ...
        <form className="w-80">
          ...
          <div className="mb-4 ">
            <label id="password" className="block text-sm font-medium text-gray-700">Senha</label>
          ...
          <p className="text-center text-sm font-bold text-gray-800">
            Esqueceu a senha?
            <a href="#" className="text-brown-600 hover:underline">Clique aqui</a>
          </p>
        </form>
      </div>
      <footer className="text-center text-sm font-bold text-gray-800 pb-6">
        Ainda não tem uma conta?
        <a href="#" className="text-brown-600 hover:underline">Cadastre-se!</a>
      </footer>
    </body>
  );
}
